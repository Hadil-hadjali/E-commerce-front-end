    ...
    <div className='footer-container'>
      ...
      <div className='footer-right'>
        ...
        <div className='contact-item'>
          <FaLocationDot className='contact-icon' /> 4031 Soussse Street, City
        </div>
        <div className='contact-item'>
          <FaPhoneAlt className='contact-icon' /> 216 2657864
        </div>
        <div className='contact-item'>
          <IoMail className='contact-icon' /> hadil.hadjali19@gmail.com
        </div>
      </div>

      <div className='footer-bottom'>© 2025 Myclays</div>
    </div>
  );
};
